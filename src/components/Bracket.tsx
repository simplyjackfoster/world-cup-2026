...
const ProgressHeader = ({
  ...
  <div className="rounded-2xl border border-slate-800 bg-gradient-to-br from-slate-900/70 to-slate-950/80 p-4 shadow-card">
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      <div>
        <p className="text-xs uppercase tracking-[0.3em] text-slate-400">Step 2 · Knockouts</p>
        <h2 className="text-2xl font-semibold">Advance teams through the bracket</h2>
...
export default function Bracket() {
  ...
  return (
    <div className="mt-6 space-y-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between rounded-2xl border border-slate-800 bg-slate-950/70 px-4 py-3">
        <div className="flex flex-wrap gap-2 text-[11px] uppercase tracking-[0.24em] text-slate-400">
          <span className="inline-flex items-center gap-2 rounded-full bg-slate-900 px-3 py-1">Step 1: Finish group tables</span>
          <span className="inline-flex items-center gap-2 rounded-full bg-slate-900 px-3 py-1">Step 2: Advance knockouts</span>
          <span className="inline-flex items-center gap-2 rounded-full bg-slate-900 px-3 py-1">Step 3: Share picks</span>
        </div>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <h3 className="text-xl font-semibold">Interactive Bracket</h3>
        </div>
        <div className="flex flex-wrap gap-2" aria-label="Bracket actions">
          ...
          <button
            className="px-3 py-2 rounded-lg border border-slate-700 bg-slate-950 text-sm font-semibold hover:border-slate-500"
          ...
          <button
            className="px-3 py-2 rounded-lg border border-red-500/60 bg-red-500/10 text-sm font-semibold text-red-100 hover:bg-red-500/20"
